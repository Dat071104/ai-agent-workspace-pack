...
| Medium | Analyze idea, create scoped prompt, bug triage, scoped audit, one feature slice | Some context reading needed | Strong general model | Confirm before edits or long scans | Usually no |
| Heavy | Multi-phase prompt, broad audit, production-readiness review, large handoff, multi-module feature | Can take time and many tokens | Strong model recommended | Confirm scope and expensive checks | Maybe |
